...
from .constance import GENDER_TYPE, ACCOUNT_TYPE
from django.contrib.auth.models import User
from .models import UserAccount, UserAdrees


class User_registation(UserCreationForm):
    ...
    class Meta:
        model = User
        fields = ['username', 'password1', 'password2', 'first_name', 'last_name', 'email', 'account_type', 'birthday','gender', 'postal_code', 'city','country', 'street_address']
...
class UserUpdateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance:
            try:
                ...
                user_address = self.instance.adrees
    ...
    def save(self, commit=True):
        ...
        if commit:
            ...
            user_address, created = UserAdrees.objects.get_or_create(user=user) 
